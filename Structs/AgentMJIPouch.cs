...
namespace Islander.Structs
{
	...
	public unsafe struct AgentMJIPouch
	{
		...
		[FieldOffset(0x28)]
		public PouchIndexInfo* InventoryIndex;

		[FieldOffset(0x30)]
		public PouchInventoryData* InventoryData;
		...
		{
			[FieldOffset(0x78)]
			public StdVector<PouchInventoryItem> Inventory;

			[FieldOffset(0x90)]
			public StdVector<Pointer<PouchInventoryItem>> Materials;

			[FieldOffset(0xA8)]
			public StdVector<Pointer<PouchInventoryItem>> Produce;

			[FieldOffset(0xC0)]
			public StdVector<Pointer<PouchInventoryItem>> StockStores;

			[FieldOffset(0xD8)]
			public StdVector<Pointer<PouchInventoryItem>> Tools;

			[FieldOffset(0xF0)]
			public StdVector<Utf8String> InventoryNames;

			[FieldOffset(0x108)]
			public uint MJIItemPouchItemCount;
		}
	}
